...
export default function CircularProgress({rate=60}) {
  ...
  return (
    ...
    <div className="w-[40px] h-[40px] rounded-full flex justify-center items-center bg-gray-900 relative">
      <div className="w-[36px] h-[36px] rounded-full flex justify-center items-center"
      style={{background:  `conic-gradient(${color} 0%  ${360*rate*0.01}deg, rgba(255,255,255,0.1) ${360 * rate * 0.01}deg 360deg)`}}
      >
